...
-- Dumping structure for table jlegacy.addon_account
...
-- Dumping data for table jlegacy.addon_account: ~8 rows (approximately)
...
-- Dumping structure for table jlegacy.addon_account_data
...
-- Dumping data for table jlegacy.addon_account_data: ~5 rows (approximately)
...
-- Dumping structure for table jlegacy.addon_inventory
...
-- Dumping data for table jlegacy.addon_inventory: ~5 rows (approximately)
...
-- Dumping structure for table jlegacy.addon_inventory_items
...
-- Dumping data for table jlegacy.addon_inventory_items: ~0 rows (approximately)

-- Dumping structure for table jlegacy.banking
...
-- Dumping data for table jlegacy.banking: ~0 rows (approximately)

-- Dumping structure for table jlegacy.billing
...
-- Dumping data for table jlegacy.billing: ~0 rows (approximately)

-- Dumping structure for table jlegacy.cardealer_vehicles
...
-- Dumping data for table jlegacy.cardealer_vehicles: ~0 rows (approximately)

-- Dumping structure for table jlegacy.datastore
...
-- Dumping data for table jlegacy.datastore: ~9 rows (approximately)
...
-- Dumping structure for table jlegacy.datastore_data
...
-- Dumping data for table jlegacy.datastore_data: ~5 rows (approximately)
...
-- Dumping structure for table jlegacy.fine_types
...
-- Dumping data for table jlegacy.fine_types: ~52 rows (approximately)
...
-- Dumping structure for table jlegacy.items
...
-- Dumping data for table jlegacy.items: ~33 rows (approximately)
...
-- Dumping structure for table jlegacy.jobs
...
-- Dumping data for table jlegacy.jobs: ~14 rows (approximately)
...
-- Dumping data for table jlegacy.job_grades: ~36 rows (approximately)
...
-- Dumping data for table jlegacy.licenses: ~6 rows (approximately)
...
-- Dumping structure for table jlegacy.multicharacter_slots
...
-- Dumping data for table jlegacy.multicharacter_slots: ~0 rows (approximately)

-- Dumping structure for table jlegacy.owned_vehicles
...
-- Dumping data for table jlegacy.owned_vehicles: ~0 rows (approximately)

-- Dumping structure for table jlegacy.rented_vehicles
...
-- Dumping data for table jlegacy.rented_vehicles: ~0 rows (approximately)

-- Dumping structure for table jlegacy.society_moneywash
...
-- Dumping data for table jlegacy.society_moneywash: ~0 rows (approximately)

-- Dumping structure for table jlegacy.users
...
-- Dumping data for table jlegacy.users: ~0 rows (approximately)

-- Dumping structure for table jlegacy.user_licenses
...
-- Dumping data for table jlegacy.user_licenses: ~0 rows (approximately)

-- Dumping structure for table jlegacy.vehicles
...
-- Dumping data for table jlegacy.vehicles: ~240 rows (approximately)
...
-- Dumping structure for table jlegacy.vehicle_categories
...
-- Dumping data for table jlegacy.vehicle_categories: ~11 rows (approximately)
...
-- Dumping structure for table jlegacy.vehicle_sold
...
-- Dumping data for table jlegacy.vehicle_sold: ~0 rows (approximately)

-- Dumping structure for table jlegacy.whitelist
CREATE TABLE IF NOT EXISTS `whitelist` (
  `identifier` varchar(46) NOT NULL,
  PRIMARY KEY (`identifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Dumping data for table jlegacy.whitelist: ~0 rows (approximately)
